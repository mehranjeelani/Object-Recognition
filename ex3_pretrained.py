...
class VggModel(nn.Module):
    def __init__(self, n_class, fine_tune, pretrained=True):
        ...
        original_model = models.vgg11_bn(pretrained=pretrained)
    ...
    def forward(self, x):
        ...
        out = self.relu(self.batch_norm(self.linear1(out)))
...
# disabling gradients of conv layers
...
torch.save(model.state_dict(), 'model_pretrained_fc.ckpt')
